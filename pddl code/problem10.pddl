(define (problem batterydrain1) (:domain canadarm3-real)
(:objects 
    ;debris1 - debris
    ;craft1 - craft
    port1 - port
...
(:init
    ...
    (= (battery-level) 10) ;how much battery the arm has currently (affected by charging and draining)
    (= (battery-drain-rate) 3) ;rate at which the battery drains when in shade
    (= (battery-charge-rate) 1) ;rate at which the battery charges when in sun
